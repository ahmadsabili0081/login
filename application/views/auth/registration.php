        ...
        <div class="p-5">
          ...
          <form class="user" method="POST" action="<?= base_url() . "auth/registration"; ?>">
            <div class="form-group">
              <input type="text" class="form-control form-control-user" value="<?= set_value('name') ?>" id="name" name="name" placeholder="Fullname">
              <?= form_error('name', '<small class="text-danger pl-3">', '</small>'); ?>
            </div>
            <div class="form-group">
              <input type="text" class="form-control form-control-user" name="email" value="<?= set_value('email') ?>" id="email" placeholder="Email Address">
